...
config.defaultSpawnCell = "Imperial Prison Ship"
-- config.defaultSpawnCell = "Seyda Neen, Census and Excise Office"


-- The X, Y and Z position that newly created players are teleported to
config.defaultSpawnPos = {75.263916015625, -160.85040283203, -104.25575256348}
-- config.defaultSpawnPos = {-58.238739013672, -205.60282897949, 193}

-- The X and Z rotation that newly created players are assigned
config.defaultSpawnRot = {0.08055467903614, -0.13957524299622}
-- config.defaultSpawnRot = {0.078764460980892, 1.0248186588287}
